                                ...
                                <div class="col-lg">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4">Admin PPDB SMK Wirakarya 2</h1>
                                        </div>
                                        <form class="user" method="POST" action="<?= base_url('lols') ?>">
                                            ...
                                            <div class="text-center">
                                                <a class="small" href="pendaftaran">Belum Mendaftar!</a>
                                            </div>
                                    </div>
                                </div>
                            </div>
