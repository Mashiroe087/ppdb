                                ...
                                <form action="<?= base_url('pengumuman/search'); ?>" method="post">
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="input-group-append">
                                            <button class="btn btn-primary" style="width: 60px;" type="submit" id="search"><i class="fas fa-search"></i></button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-hover text-dark">
                                    ...
                                    <tbody class="text-center">
                                        <?php foreach ($siswa->result_array() as $s) : ?> <tr class="table-success">
                                                <!-- <td><?= ++$page; ?></td> -->
